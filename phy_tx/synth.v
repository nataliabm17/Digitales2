...
module byte_striping_synth(clk_2f, valid_in, data_in, reset, lane_0, lane_1, valid_0, valid_1);
...
module etapa2_flops_synth(data_in0, valid_in0, data_out0, valid_out0, clk_2f, reset);
